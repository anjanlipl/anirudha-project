...
class VidhansabhaController extends Controller
{
    ...
    public function getVidhanshabhaList()
    {
        $sectors = Vidhanshabha::all();
       return response()->json(['vidhansabhas'=>$sectors]);
