...
class ReportController extends Controller
{
    ...
    public function getOutcomeIndMetrics($allObjectiveOutcomeIndicators, $request)
    {
        # code...
    ...
    public function getOutputIndMetrics($allObjectiveOutputIndicators, $request)
    {
        # code...
        // $current_begin_date = date('Y-04-01', strtotime('-2 years'));
        // $current_end_date = date('Y-03-31', strtotime('-1 years'));
