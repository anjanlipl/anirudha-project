    ...
    <div class="form_wrapper">
      ...
      <form action="{{route('scheme.store')}}" method="post">
          ...
          <div class="col col-md-6">
              ...
              <div class="col col-md-6">
                ...
                <div class="form-group">
                  <label for="budget">Add more Estimates
                :</label>
                <button class="form-control btn btn-primary addRE" style="width:20%;margin-left:40%;" id="addRE"><i class="fa fa-plus"></i></button>
                </div>
              </div>
       ...
       <div class="row" style="margin-top: 10px;">
               <div class="col col-md-12" style="text-align: center;font-weight: 600;font-size: 1.7rem;border-bottom: 1px solid #ddd;border-top: 1px solid #ddd;margin-bottom:10px;background-color: darkcyan;color:white;">Outputs <button class=" addOutput" style="width:20%;margin-left:20px;" id="addOutput"><i class="fa fa-plus"></i></button></div>
          <div class="output-wrapper" id="output-wrapper">
              <div class="one-output" id="one-output">
                <div class="row">
                  <div class="col col-md-4">
                      <div class="col col-md-12">
                    <div class="form-group">
                          <label for="budget">Detail
                        :</label>
                        <textarea rows="5" style="width:100%;" name="objective"  ></textarea>
                      </div>
                      <div class="header-in-form">Indicator</div>
                  </div>
                    
                                       
                   <div class="indicator-wrapper" id="indicator-wrapper">
                      <div class="one-indicator" id="one-indicator">
                        <div class="row">
                            <div class="col col-md-6">
                                  <div class="col col-md-6">
                              ...
                              <div class="col col-md-6">
                                  ...
                                  <div class="col col-md-6">
                                      ...
                                      :</label>
                                      <select  required name="capital_be" class="form-control" >
                                        <option value="0">NA</option>
                                        <option value="1">In progress</option>
                                        <option value="2">Ontrack</option>
                                      </select>
                                    </div>
                                  ...
                                  <div class="col col-md-12">
                                      <div class="form-group">
                                       <label for="budget">Add More Indicators
                                      :</label>
                                        <button class="form-control btn btn-primary addOI" style="width:20%;margin-left:40%;" id="addOI"><i class="fa fa-plus"></i></button>
                                    </div>
                                  </div>
                              </div>
                                </div> <!-- end row -->
                  ...
                  <div class="col col-md-8">
                       <div class="header-in-form">Outcome</div>
                        <div class="outcome-wrapper">
                          
                          <div class="one-outcome">
