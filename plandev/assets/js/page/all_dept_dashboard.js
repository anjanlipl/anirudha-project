	...
	$.ajax({async: true,
			...
			success: function(result){
				...
				//    if(value.length > 0){
				   ...
				   var htm = '<div class="col-md-3 dash-sec-thumb-main" data-perf="'+perf+'"><div class="dash-sec-thumb '+cls+'"><a class="anch" data-target="#chartDrop_'+sector.id+'"><div class="title">'+sector.name+'</div></a><div class="dash-sec-thumb-dets" id="chartDrop_'+sector.id+'"><canvas id="chartCan_'+sector.id+'" width="500"></canvas></div><div class="thumb-ind-wrap"><div class="row"><div class="col-md-6"><a class="anch" data-target="#chartDrop_'+sector.id+'"><span class="thumb-ind-item">'+result.xtotalNa[sector.id]+'</span><span class="thumb-ind-item green">'+result.xontrack[sector.id]+'</span><span class="thumb-ind-item red">'+result.xofftrack[sector.id]+'</span><span class="thumb-ind-item yellow">'+result.xinprogress[sector.id]+'</span></a></div><div class="col-md-6"><div class="sub-anchor-drop-in"><a href="dept_dashboard.html?dept_id='+sector.id+'">Schemes</a></div></div></div></div><span class="sub-anchor" w3-include-html="assets/icons/dots.html"></span><div class="sub-anchor-drop"></div></div></div>';
	...
	$.ajax({async: true,
			...
			success: function(result){
				...
				$.each( result.departments, function( key, value ) {
				   ...
				   var htm = '<div class="col-md-3 dash-sec-thumb-main" data-perf="'+perf+'"><div class="dash-sec-thumb '+cls+'"><a class="anch" data-target="#chartDrop6_'+sector.id+'"><div class="title">'+sector.name+'</div></a><div class="dash-sec-thumb-dets" id="chartDrop6_'+sector.id+'"><canvas id="chartCan6_'+sector.id+'" width="500"></canvas></div><div class="thumb-ind-wrap"><div class="row"><div class="col-md-6"><a class="anch" data-target="#chartDrop6_'+sector.id+'"><span class="thumb-ind-item">'+result.xtotalNa[sector.id]+'</span><span class="thumb-ind-item green">'+result.xontrack[sector.id]+'</span><span class="thumb-ind-item red">'+result.xofftrack[sector.id]+'</span><span class="thumb-ind-item yellow">'+result.xinprogress[sector.id]+'</span></a></div><div class="col-md-6"><div class="sub-anchor-drop-in"><a href="dept_dashboard.html?dept_id='+sector.id+'">Schemes</a></div></div></div></div><span class="sub-anchor" w3-include-html="assets/icons/dots.html"></span><div class="sub-anchor-drop"></div></div></div>';
