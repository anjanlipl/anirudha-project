	...
	$.ajax({async: true,
		...
		success: function(result){
			...
			$.each( result.schemes, function( key, value ) {
			   ...
			   var htm = '<div class="col-md-4 dash-sec-thumb-main" data-perf="'+perf+'"><div class="dash-sec-thumb active"><div class="anch"><div class="title">'+sector.name+'</div></div><div class="dash-sec-thumb-dets" id="chartDrop2_'+key+'"><canvas id="chartCan2_'+key+'" width="500"></canvas></div><div class="thumb-ind-wrap"><div class="row"><div class="col-md-6"><div class="indi"><span class="thumb-ind-item">'+result.totalEst[key]+'</span><span class="thumb-ind-item green">'+result.totalExp[key]+'</span></div></div><div class="col-md-6"><div class="sub-anchor-drop-in"><a href="scheme_dashboard.html?scheme_id='+sector.id+'">More</a></div></div></div></div><div class="sub-anchor-drop"></div></div></div>';
		...
		success: function(result){
			...
			$.each( result.departments, function( key, value ) {
			   	...
			   	if (!isFinite(perf))
				{
			   	...
			   	var htm = '<div class="col-md-4 dash-sec-thumb-main" data-perf="'+perf+'"><div class="dash-sec-thumb active"><div class="anch"><div class="title">'+sector.name+'</div></div><div class="dash-sec-thumb-dets" id="chartDrop_'+sector.id+'"><canvas id="chartCan_'+sector.id+'" width="500"></canvas></div><div class="thumb-ind-wrap"><div class="row"><div class="col-md-6"><div class="indi"><span class="thumb-ind-item">'+result.xtotalNa[sector.id]+'</span><span class="thumb-ind-item green">'+result.xontrack[sector.id]+'</span><span class="thumb-ind-item red">'+result.xofftrack[sector.id]+'</span><span class="thumb-ind-item yellow">'+result.xinprogress[sector.id]+'</span></div></div><div class="col-md-6"><div class="sub-anchor-drop-in"><a href="scheme_dashboard.html?scheme_id='+sector.id+'">More</a></div></div></div></div><div class="sub-anchor-drop"></div></div></div>';
				var htm2 = '';
		...
		success: function(result){
			...
			$.each( result.departments, function( key, value ) {
			   	...
			   	if (!isFinite(perf))
				{
			   	...
			   	var htm = '<div class="col-md-4 dash-sec-thumb-main" data-perf="'+perf+'"><div class="dash-sec-thumb active"><div class="anch"><div class="title">'+sector.name+'</div></div><div class="dash-sec-thumb-dets" id="chartDrop7_'+sector.id+'"><canvas id="chartCan7_'+sector.id+'" width="500"></canvas></div><div class="thumb-ind-wrap"><div class="row"><div class="col-md-6"><div class="indi"><span class="thumb-ind-item">'+result.xtotalNa[sector.id]+'</span><span class="thumb-ind-item green">'+result.xontrack[sector.id]+'</span><span class="thumb-ind-item red">'+result.xofftrack[sector.id]+'</span><span class="thumb-ind-item yellow">'+result.xinprogress[sector.id]+'</span></div></div><div class="col-md-6"><div class="sub-anchor-drop-in"><a href="scheme_dashboard.html?scheme_id='+sector.id+'">More</a></div></div></div></div><div class="sub-anchor-drop"></div></div></div>';
				var htm2 = '';
