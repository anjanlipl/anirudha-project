...
<div class="container">
  ...
  <div class="page-header">
  		<span class="header-text">Admin Dashboard</span></span>
  	...
  	<div class="row underlined-row">
  		...
  		<div class="col col-md-6">
  			<div class="form-group">
  				<label for="schemes" class="space-10">Select Department : </label>
  				<select id="report_department_id">
            <option value="0">--select department--</option>
  			...
  			<div class="form-group">
  				...
  				<button class="btn btn-primary view-organisation-progress">View Progress</button>
  			</div>
  		</div>
...
<script type="text/javascript" src="{{asset('js/dashboard/admin.js')}}" defer></script>